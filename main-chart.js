...
!(function (t, e) {
    ...
    for (l = 0; l < r; l++)
      if (((d = i[l]), null != d && !0 !== Y(d))) a = Yt(t, n, o, a, d);
        ...
        for (h = 0, c = d.length; h < c; h++)
          (u = d[h]), null == u || Y(u) || (a = Yt(t, n, o, a, u));
    t.restore();
    const f = o.length / 2;
    if (f > i.length) {
  ...
  function Oe(t, e, i, s, n) {
    ...
    return (
      De(t, i, e, function (i, l, h) {
        if (s && !i.inRange(e.x, e.y, n)) return;
        const c = i.getCenterPoint(n);
        if (!Gt(c, t.chartArea, t._minPadding) && !i.inRange(e.x, e.y, n))
          return;
        const d = o(e, c);
        d < a
  ...
  function Qe(t, e, i, s) {
    ...
    for (o = 0, a = t.length, h = 0; o < a; ++o) {
      (r = t[o]),
        (l = r.box),
        l.update(r.width || e.w, r.height || e.h, Ze(r.horizontal, e));
    ...
    for (const r of t) {
      ...
      if (r.horizontal) {
        ...
        ct(l.start) && (a = l.start),
          t.fullSize
            ? Je(t, n.left, a, i.outerWidth - n.right - n.left, o)
            : Je(t, e.left + l.placed, a, s, o),
          (l.start = a),
          (l.placed += s),
          (a = t.bottom);
      } else {
        ...
        ct(l.start) && (o = l.start),
          t.fullSize
            ? Je(t, o, n.top, a, i.outerHeight - n.bottom - n.top)
            : Je(t, o, e.top + l.placed, a, s),
          (l.start = o),
          (l.placed += s),
          (o = t.right);
      }
  ...
  var ei = {
    ...
    update(t, e, i, s) {
      ...
      Qe(r.fullSize, f, d, g),
        ...
        ti(r.leftAndTop, f, d, g),
        (f.x += f.w),
        (f.y += f.h),
        ti(r.rightAndBottom, f, d, g),
        (t.chartArea = {
          left: f.left,
          top: f.top,
          right: f.left + f.w,
  ...
  function vi(t, e, i, s, n) {
    ...
    if (
      ...
      for (o = 0, a = t.length; o < a; ++o)
        (r = t[o]),
          (l = bi(i, r, t[Math.min(o + 1, a - (s ? 0 : 1)) % a], e.tension)),
          (r.cp1x = l.previous.x),
          (r.cp1y = l.previous.y),
          (r.cp2x = l.next.x),
          (r.cp2y = l.next.y),
        ...
        for (i = 0, s = t.length; i < s; ++i)
          (a = o),
            ...
            o &&
              ((n = t[i]),
              a &&
                ((n.cp1x = yi(n.cp1x, e.left, e.right)),
                (n.cp1y = yi(n.cp1y, e.top, e.bottom))),
              r &&
                ((n.cp2x = yi(n.cp2x, e.left, e.right)),
                (n.cp2y = yi(n.cp2y, e.top, e.bottom))));
      })(t, i);
  }
  const wi = (t) => 0 === t || 1 === t,
    Mi = (t, e, i) =>
    ...
    Si = {
      ...
      easeInElastic: (t) => (wi(t) ? t : Mi(t, 0.075, 0.3)),
      easeOutElastic: (t) => (wi(t) ? t : ki(t, 0.075, 0.3)),
      easeInOutElastic(t) {
        const e = 0.1125;
        return wi(t)
          ? t
  ...
  function zi(t, e, i) {
    ...
    const { property: s, start: n, end: o } = i,
      a = e.length,
      { compare: r, between: l, normalize: h } = Ei(s),
      {
        start: c,
        end: d,
        loop: u,
      ...
      (m = e[t % a]),
        m.skip ||
          ...
          p !== x &&
            ...
            null !== _ &&
              v() &&
              (g.push(Ii({ start: _, end: t, loop: u, count: a, style: f })),
              (_ = null)),
            (i = t),
            (x = p)));
    return (
      null !== _ &&
        g.push(Ii({ start: _, end: d, loop: u, count: a, style: f })),
      g
    );
  }
  function Fi(t, e) {
  ...
  class ss extends ji {
    ...
    removeEventListener(t, e) {
      const i = t.$proxies || (t.$proxies = {}),
        s = i[e];
      if (!s) return;
      (({ attach: es, detach: es, resize: es }[e] || qi)(t, e, s),
        (i[e] = void 0));
    }
    getDevicePixelRatio() {
  ...
  class ls {
    constructor(t, e, i, s) {
      ...
      (this._active = !0),
        (this._fn = t.fn || rs[t.type || typeof o]),
    ...
    update(t, e, i) {
      if (this._active) {
        ...
        (this._start = i),
          ...
          (this._total += n),
          (this._loop = !!t.loop),
          (this._to = We([t.to, e, s, t.from])),
          (this._from = We([t.from, s, e]));
      }
    }
    cancel() {
      this._active &&
  ...
  function xs(t, e) {
    ...
    for (let t = 0; t < d; ++t) {
      const i = e[t],
        { [l]: o, [h]: d } = i;
      (u = (i._stacks || (i._stacks = {}))[h] = ps(n, c, o)),
        (u[r] = d),
        (u._top = ms(u, a, !0, s.type)),
        (u._bottom = ms(u, a, !1, s.type));
    }
  }
  function bs(t, e) {
    const i = t.scales;
  ...
  class ws {
    ...
    _dataCheck() {
      ...
      if (U(e))
        ...
        e && Object.isExtensible(e) && he(e, this),
          (this._syncList = []),
          (this._data = e);
      }
    }
    ...
    buildOrUpdateElements(t) {
      ...
      (e._stacked = gs(e.vScale, e)),
        e.stack !== i.stack && ((s = !0), _s(e), (e.stack = i.stack)),
        this._resyncElements(t),
        (s || n !== e._stacked) && xs(this, e._parsed);
    }
    configure() {
    ...
    applyStack(t, e, i) {
      const s = this.chart,
        n = this._cachedMeta,
        o = e[t.axis];
      return fs({ keys: us(s, !0), values: e._stacks[t.axis] }, o, n.index, {
        mode: i,
      });
    }
    updateRangeFromParsed(t, e, i, s) {
      ...
      s && a && ((s.values = a), (o = fs(s, n, this._cachedMeta.index))),
    ...
    getMinMax(t, e) {
      const i = this._cachedMeta,
        ...
        r = ((t, e, i) =>
          t && !e.hidden && e._stacked && { keys: us(i, !0), values: null })(
          e,
          i,
          this.chart
        ),
    ...
    _resolveElementOptions(t, e = "default", i) {
      ...
      return (
        f.$shared && ((f.$shared = r), (n[o] = Object.freeze(vs(f, r)))), f
      );
    }
  ...
  function Ps(t, e) {
    ...
    if (o > 0) {
      ...
      for (Ds(e, l, h, $(s) ? 0 : a - s, a), t = 0, i = o - 1; t < i; t++)
        Ds(e, l, h, n[t], n[t + 1]);
  ...
  class Es extends Ms {
    ...
    update(t, e, i) {
      ...
      this.beforeUpdate(),
        ...
        this._dataLimitsCached ||
          ...
          (this._range = Ne(this, n, s)),
          (this._dataLimitsCached = !0)),
        this.beforeBuildTicks(),
        (this.ticks = this.buildTicks() || []),
        this.afterBuildTicks();
      const r = a < this.ticks.length;
      this._convertTicksToLabels(r ? Os(this.ticks, a) : this.ticks),
        this.configure(),
        ...
        o.display &&
          ...
          ((this.ticks = Ps(this, this.ticks)), (this._labelSizes = null)),
      ...
      (o = t.offset ? this.maxWidth / i : u / (i - 1)),
        c + 6 > o &&
          ...
          (a =
            ...
            Ts(t.grid) -
            e.padding -
            Ls(t.title, this.chart.options.font)),
          (r = Math.sqrt(c * c + d * d)),
          (l = It(
            Math.min(
    ...
    fit() {
      ...
      if (o) {
        ...
        if (
          (a
            ? ((t.width = this.maxWidth), (t.height = Ts(n) + o))
            : ((t.height = this.maxHeight), (t.width = Ts(n) + o)),
    ...
    drawBorder() {
      ...
      let r, l, h, c;
      this.isHorizontal()
        ? ((r = Xt(t, this.left, n) - n / 2),
          (l = Xt(t, this.right, o) + o / 2),
          (h = c = a))
        : ((h = Xt(t, this.top, n) - n / 2),
          (c = Xt(t, this.bottom, o) + o / 2),
          (r = l = a)),
        e.save(),
      ...
      const {
        ...
        if (t.isHorizontal()) {
          if (((f = n(s, a, l)), U(i))) {
            ...
            g = "center" === i ? (c.bottom + c.top) / 2 + m - e : Cs(t, i, e);
          u = l - a;
        } else {
          if (U(i)) {
            const t = Object.keys(i)[0],
            ...
            f = "center" === i ? (c.left + c.right) / 2 - x + e : Cs(t, i, e);
  ...
  var zs = new (class {
    constructor() {
      (this.controllers = new Is(ws, "datasets", !0)),
        (this.elements = new Is(Ms, "elements")),
        (this.plugins = new Is(Object, "plugins")),
        (this.scales = new Is(Es, "scales")),
        ...
        ? (function (t, e, i, s) {
            ...
            for (let a = 0; a < e.length; a++) {
              const r = e[a],
                l = Bs(i[r.id], s);
              null !== l &&
                n.push({ plugin: r, options: Vs(t.config, r, l, o) });
            }
            return n;
          })(t, n, s, e)
        : [];
  ...
  class qs {
    ...
    getOptionScopes(t, e, i) {
      ...
      const r = new Set();
      e.forEach((e) => {
        t && (r.add(t), e.forEach((e) => Xs(r, t, e))),
          e.forEach((t) => Xs(r, s, t)),
          e.forEach((t) => Xs(r, ft[n] || {}, t)),
          e.forEach((t) => Xs(r, xt, t)),
          e.forEach((t) => Xs(r, gt, t));
      });
    ...
    createResolver(t, e, i = [""], s) {
      const { resolver: n } = Ks(this._resolverCache, t, i);
  ...
  class an {
    constructor(t, e) {
      ...
      (this.platform = new (s.platform || ns(n))()),
      ...
      (this.id = j()),
        ...
        (nn[this.id] = this),
        l && h
          ? (a.listen(this, "complete", tn),
            a.listen(this, "progress", en),
            this._initialize(),
      ...
      e &&
        ...
        J(n, (e) => {
          const n = e.options,
            ...
            a = Ns(o, n),
            r = K(n.type, e.dtype);
          (void 0 !== n.position && Qs(n.position, a) === Qs(e.dposition)) ||
    ...
    buildOrUpdateControllers() {
      ...
      for (
        ...
        if (
          ...
          (n.type = o),
          (n.indexAxis = s.indexAxis || Ws(o, this.options)),
          (n.order = s.order || 0),
          (n.index = i),
          (n.label = "" + s.label),
    ...
    update(t) {
      ...
      const n = new Set(Object.keys(this._listeners)),
        o = new Set(i.events);
      if (
        ((ut(n, o) && !!this._responsiveListeners === i.responsive) ||
  ...
  Object.defineProperties(an, {
    defaults: { enumerable: ln, value: xt },
    instances: { enumerable: ln, value: nn },
    overrides: { enumerable: ln, value: ft },
    registry: { enumerable: ln, value: zs },
    version: { enumerable: ln, value: "3.6.0" },
    getChart: { enumerable: ln, value: on },
    register: {
      enumerable: ln,
      value: (...t) => {
        zs.add(...t), rn();
  ...
  function _n(t, { inflateAmount: e }, i) {
      ...
      for (let c = e; c < e + i; c++) {
        const e = this.getParsed(c),
          ...
          p = {
            ...
            base: i.base,
            enableBorderRadius:
              !g || pn(e._custom) || o === g._top || o === g._bottom,
            x: l ? i.head : f.center,
            y: l ? f.center : i.head,
        ...
        if (t._sorted) {
          ...
          d &&
            (n = Ht(
              Math.min(
                oe(r, a.axis, h).lo,
                i ? s : oe(e, l, a.getPixelForValue(h)).lo
              ),
              0,
              s - 1
            )),
            (o = u
              ? Ht(
                  Math.max(
                    oe(r, a.axis, c).hi + 1,
                    i ? 0 : oe(e, l, a.getPixelForValue(c)).hi + 1
                  ),
                  n,
                  s
                ) - n
  ...
  function An(t, e, i, s) {
    const n = Ie(t.options.borderRadius, [
      "outerStart",
      "outerEnd",
      "innerStart",
      "innerEnd",
  ...
  function Bn(t, e, i, s) {
    const { points: n, options: o } = e,
      { count: a, start: r, loop: l, ilen: h } = Fn(n, i, s),
      c = (function (t) {
        return t.stepped
          ? Jt
  ...
  (En.id = "arc"),
    ...
    (En.defaultRoutes = { backgroundColor: "backgroundColor" });
  const Nn = "function" == typeof Path2D;
  function Hn(t, e, i, s) {
    Nn && !e.options.segment
      ? (function (t, e, i, s) {
          let n = e._path;
  ...
  class jn extends Ms {
    ...
    get segments() {
      return (
        this._segments || (this._segments = Bi(this, this.options.segment))
      );
    }
    first() {
    ...
    draw(t, e, i, s) {
      ...
      (this.points || []).length &&
        n.borderWidth &&
        (t.save(), Hn(t, this, i, s), t.restore()),
  ...
  class Yn extends Ms {
    ...
    draw(t, e) {
      ...
      this.skip ||
        i.radius < 0.1 ||
        !Gt(this, e, this.size(i) / 2) ||
        ((t.strokeStyle = i.borderColor),
        (t.lineWidth = i.borderWidth),
        (t.fillStyle = i.backgroundColor),
        Kt(t, i, this.x, this.y));
    }
    getRange() {
      const t = this.options || {};
    ...
    beforeElementsUpdate: (t, e, i) => {
      ...
      t.data.datasets.forEach((e, n) => {
        ...
        let { start: c, count: d } = (function (t, e) {
          ...
          return (
            l && (n = Ht(oe(e, o.axis, a).lo, 0, i - 1)),
            (s = h ? Ht(oe(e, o.axis, r).hi + 1, n, i) - n : i - n),
            { start: n, count: s }
          );
        })(r, l);
  ...
  function co(t, e) {
    ...
    return (
      ...
      i.length
        ? new jn({ points: i, options: { tension: 0 }, _loop: s, _fullLoop: s })
        : null
    );
  }
  function uo(t, e, i) {
      ...
      (function (t, e) {
        ...
        t.save(),
          "x" === l &&
            o !== n &&
            (fo(t, s, a.top),
            bo(t, { line: i, target: s, color: n, scale: r, property: l }),
            t.restore(),
            t.save(),
            fo(t, s, a.bottom)),
  ...
  class wo extends Ms {
    ...
    _draw() {
      const { options: t, columnSizes: e, lineWidths: i, ctx: s } = this,
        { align: a, labels: r } = t,
        l = xt.color,
        h = Ti(t.rtl, this.left, this.width),
        c = Ve(r.font),
        { color: d, padding: u } = r,
        f = c.size,
        g = f / 2;
      ...
      this.drawTitle(),
        ...
        (s.lineWidth = 0.5),
        (s.font = c.string);
      const { boxWidth: m, boxHeight: x, itemHeight: b } = vo(r, f),
        _ = this.isHorizontal(),
  ...
  function Eo(t, e, i) {
    ...
    return { xAlign: e.xAlign || Ro(t, e, i, s), yAlign: s };
  }
  function Io(t, e, i, s) {
    const { caretSize: n, caretPadding: o, cornerRadius: a } = t,
      { xAlign: r, yAlign: l } = i,
      h = n + o,
      { topLeft: c, topRight: d, bottomLeft: u, bottomRight: f } = Fe(a);
    let g = (function (t, e) {
      let { x: i, width: s } = t;
  ...
  class Vo extends Ms {
    ...
    getContext() {
      return (
        ...
        (this.$context =
          ...
          He(t, { tooltip: e, tooltipItems: i, type: "tooltip" })))
      );
      var t, e, i;
    }
    getTitle(t, e) {
      ...
      return (
        J(t, (t) => {
          const e = { before: [], lines: [], after: [] },
            n = Bo(i, t);
          Oo(e.before, Ao(n.beforeLabel.call(this, t))),
            Oo(e.lines, n.label.call(this, t)),
            Oo(e.after, Ao(n.afterLabel.call(this, t))),
            s.push(e);
        }),
        s
      );
    ...
    getCaretPosition(t, e, i) {
      const { xAlign: s, yAlign: n } = this,
        ...
        { topLeft: r, topRight: l, bottomLeft: h, bottomRight: c } = Fe(a),
        { x: d, y: u } = t,
        { width: f, height: g } = e;
      let p, m, x, b, _, y;
      return (
    ...
    _drawColorBox(t, e, i, s, n) {
      ...
      if (n.usePointStyle) {
        ...
        Object.values(a).some((t) => 0 !== t)
          ? (t.beginPath(),
            (t.fillStyle = n.multiKeyBackground),
            se(t, { x: e, y: g, w: l, h: r, radius: a }),
            t.fill(),
            t.stroke(),
            (t.fillStyle = o.backgroundColor),
            t.beginPath(),
            se(t, { x: i, y: g + 1, w: l - 2, h: r - 2, radius: a }),
            t.fill())
          : ((t.fillStyle = n.multiKeyBackground),
            t.fillRect(e, g, l, r),
  ...
  var Wo = {
      ...
      positioners: Co,
      afterInit(t, e, i) {
        i && (t.tooltip = new Vo({ _chart: t, options: i }));
      },
      beforeUpdate(t, e, i) {
      ...
      return ((t, e) =>
        null === t
          ...
          : Ht(
              ...
              0,
              e
            ))((e = isFinite(e) && i[e] === t ? e : Ho(i, t, K(e, t))), i.length - 1);
    }
    determineDataLimits() {
  ...
  (jo.id = "category"),
    (jo.defaults = { ticks: { callback: jo.prototype.getLabelForValue } });
  class Yo extends Es {
    constructor(t) {
      super(t),
        (this.start = void 0),
      ...
      const s = (function (t, e) {
        ...
        for (
          ...
          (d && v !== o
            ? (i.push({ value: o }),
              v < o && P++,
              Tt(Math.round((v + P * k) * y) / y, o, $o(o, _, t)) && P++)
            : v < o && P++);
          P < M;
          ++P
        )
        ...
        return (
          x && d && w !== a
            ? i.length && Tt(i[i.length - 1].value, a, $o(a, _, t))
  ...
  (Uo.id = "linear"),
    (Uo.defaults = { ticks: { callback: Ss.formatters.numeric } });
  class qo extends Es {
    constructor(t) {
      super(t),
        (this.start = void 0),
  ...
  (qo.id = "logarithmic"),
    (qo.defaults = {
      ticks: { callback: Ss.formatters.logarithmic, major: { enabled: !0 } },
    });
  class sa extends Yo {
    constructor(t) {
      super(t),
    ...
    setDimensions() {
      (this.width = this.maxWidth),
        (this.height = this.maxHeight),
        (this.paddingTop = Ko(this.options) / 2),
    ...
    generateTickLabels(t) {
      Yo.prototype.generateTickLabels.call(this, t),
  ...
  (sa.id = "radialLinear"),
    (sa.defaults = {
      ...
      grid: { circular: !1 },
      startAngle: 0,
      ticks: { showLabelBackdrop: !0, callback: Ss.formatters.numeric },
      pointLabels: {
  ...
  class da extends Es {
    ...
    buildTicks() {
      ...
      return (
        (this._unit =
          e.unit ||
          (i.autoSkip
            ? la(e.minUnit, this.min, this.max, this._getLabelCapacity(n))
            : (function (t, e, i, s, n) {
                for (let o = oa.length - 1; o >= oa.indexOf(i); o--) {
                  const i = oa[o];
                  if (na[i].common && t._adapter.diff(n, s, i) >= e - 1)
                    return i;
                }
    ...
    _generate() {
      ...
      return (
        (c !== i && "ticks" !== s.bounds && 1 !== d) || ha(h, c, f),
        Object.keys(h)
          .sort((t, e) => t - e)
          .map((t) => +t)
      );
  ...
  function ua(t, e, i) {
    let s,
      ...
      l = t.length - 1;
    i
      ? (e >= t[r].pos && e <= t[l].pos && ({ lo: r, hi: l } = oe(t, "pos", e)),
        ({ pos: s, time: o } = t[r]),
        ({ pos: n, time: a } = t[l]))
      : (e >= t[r].time &&
          e <= t[l].time &&
          ({ lo: r, hi: l } = oe(t, "time", e)),
        ({ time: s, pos: o } = t[r]),
        ({ time: n, pos: a } = t[l]));
    const h = n - s;
  ...
  class fa extends da {
    ...
    initOffsets() {
      ...
      (this._minPos = ua(e, this.min)),
        (this._tableRange = ua(e, this.max) - this._minPos),
        super.initOffsets(t);
    }
    buildLookupTable(t) {
  ...
  return (
    an.register(Cn, ga, Jn, No),
    (an.helpers = { ...Hi }),
    (an._adapters = dn),
    (an.Animation = ls),
    (an.Animations = cs),
    (an.animator = a),
    (an.controllers = zs.controllers.items),
    (an.DatasetController = ws),
    (an.Element = Ms),
    (an.elements = Jn),
    (an.Interaction = Te),
    (an.layouts = ei),
    ...
    (an.Scale = Es),
    (an.Ticks = Ss),
    Object.assign(an, Cn, ga, Jn, No, os),
    (an.Chart = an),
